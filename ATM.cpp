...
sClientData ConvertLinetoRecord(string Line, string Seperator = "#//#")
{
...
vector <sClientData> LoadCleintsDataFromFile(string FileName)
{
...
bool FindClientByAccountNumberAndPinCode(string AccountNumber, string PinCode, sClientData& Client)
{

    vector <sClientData> vClients = LoadCleintsDataFromFile(ClientsFileName);
...
vector <sClientData> SaveCleintsDataToFile(string FileName, vector <sClientData> vClients)
{
...
bool DepositBalanceToClientByAccountNumber(string AccountNumber, double Amount, vector <sClientData>& vClients){
    char Answer = 'n';
...
void PerfromMainMenueOption(enMainMenueOptions MainMenueOptionChoice) {

    switch (MainMenueOptionChoice)
    {
